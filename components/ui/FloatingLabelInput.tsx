      ...
      <div className="relative w-full group">
        ...
        <label
          className={cn(
            ...
            !!icon && 'left-11',
            props.type === 'date'
              ? 'top-2 text-xs font-bold text-[var(--saffron-600)]' // Date input always elevated
              : 'top-1/2 -translate-y-1/2 text-sm text-[var(--text-tertiary)] peer-focus:top-2 peer-focus:-translate-y-0 peer-focus:text-xs peer-focus:font-bold peer-focus:text-[var(--saffron-600)] peer-[&:not(:placeholder-shown)]:top-2 peer-[&:not(:placeholder-shown)]:-translate-y-0 peer-[&:not(:placeholder-shown)]:text-xs peer-[&:not(:placeholder-shown)]:font-bold peer-[&:not(:placeholder-shown)]:text-[var(--text-secondary)]'
          )}
        >
          {label}
        </label>
        ...
        {error && (
          <motion.span 
            ...
            className="absolute -bottom-5 left-1 text-xs font-bold text-[var(--ruby-600)] tracking-wide"
          >
            {error}
          </motion.span>
        )}
